...
// `category` (Boys/Girls/Newborn), and search understands garment types, colors, and gender.
//
// IMAGES: each entry in `images` is { url, alt } so every <img> can render as
